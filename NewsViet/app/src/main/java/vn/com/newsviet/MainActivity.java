...
public class MainActivity extends AppCompatActivity {
    ...
    String URL1 = "https://cdn.24h.com.vn/upload/rss/anninhhinhsu.rss";
    ...
    private void loadData() {
        if (!Utils.isNetworkConnected(MainActivity.this)) {
            new ShowPopup(MainActivity.this).info(getString(R.string.required), getString(R.string.title_notify)).show();
        } else {
